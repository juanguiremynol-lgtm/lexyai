...
-- Fix 2: missing lifecycle tracking columns on work_items
ALTER TABLE public.work_items
  ADD COLUMN IF NOT EXISTS lifecycle_actor text,
  ADD COLUMN IF NOT EXISTS lifecycle_actor_user uuid,
