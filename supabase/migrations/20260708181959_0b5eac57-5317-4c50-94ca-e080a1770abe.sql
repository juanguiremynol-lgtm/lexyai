...
SELECT id, organization_id, radicado, workflow_type, 'ACT_SCRAPE_RETRY', 'cpnu', now(), 1, 3, NULL, 'gateB-hearing-7b038fac-v5'
...
ON CONFLICT (work_item_id, kind) DO UPDATE SET
  ...
  last_error_message = 'gateB-hearing-7b038fac-v5', updated_at = now();
