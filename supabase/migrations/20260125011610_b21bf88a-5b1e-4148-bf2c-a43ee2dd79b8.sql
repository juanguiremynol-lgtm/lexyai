-- Update the audit trigger function to explicitly bypass RLS
-- by using a direct INSERT that doesn't go through RLS checks

-- Grant the postgres role direct insert rights
GRANT INSERT ON public.audit_logs TO postgres;

-- Recreate the function to use the postgres role context properly
...
GRANT EXECUTE ON FUNCTION public.audit_trigger_write_audit_log() TO authenticated;
GRANT EXECUTE ON FUNCTION public.audit_trigger_write_audit_log() TO service_role;