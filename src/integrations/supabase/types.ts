  ...
  public: {
    Tables: {
      ...
      whatsapp_identities: {
        ...
        Relationships: [
          {
            foreignKeyName: "whatsapp_identities_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "email_recipients_by_org"
            referencedColumns: ["organization_id"]
      ...
      whatsapp_leads: {
        ...
        Relationships: [
          {
            foreignKeyName: "whatsapp_leads_conversation_id_fkey"
            columns: ["conversation_id"]
            isOneToOne: false
      ...
      whatsapp_link_codes: {
        Row: {
          code_hash: string
          consumed_at: string | null
          consumed_phone_e164: string | null
          created_at: string
          expires_at: string
          id: string
          organization_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "whatsapp_link_codes_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "email_recipients_by_org"
            referencedColumns: ["organization_id"]
    ...
    Views: {
      cpnu_freshness_overview: {
        Row: {
          db_max_act_date: string | null
          last_cpnu_buscar_at: string | null
          last_crawled_at: string | null
          last_snapshot_max_date: string | null
          last_source_mode: string | null
          last_sync_at: string | null
      ...
      email_recipients_by_org: {
        Row: {
          alert_email_verified: boolean | null
          email_reminders_enabled: boolean | null
          full_name: string | null
          org_active: boolean | null
          org_email_suspended: boolean | null
          organization_id: string | null
    ...
    Functions: {
      ...
      validate_prorroga_peticion: {
        Args: {
          p_communicated_on: string
          p_extended_term_days: number
          p_original_due_date: string
          p_original_term_days: number
        }
        Returns: Json
      }
