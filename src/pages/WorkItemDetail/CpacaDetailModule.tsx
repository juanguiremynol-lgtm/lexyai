...
export default function CpacaDetailModule({ workItem }: Props) {
  ...
  const stageLabel = getStageLabel("CPACA", workItem.stage);
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-serif font-bold">{workItem.title || "Proceso CPACA"}</h1>
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-2 gap-4">
          ...
          <div><p className="text-sm text-muted-foreground">Tribunal</p><p>{workItem.authority_name || "Sin tribunal"}</p></div>
