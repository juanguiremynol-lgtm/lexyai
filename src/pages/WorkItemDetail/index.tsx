    ...
    queryFn: async () => {
      ...
      if (cpacaData) {
        return {
          ...
          authority_name: cpacaData.despacho || null,
          authority_email: null,
          authority_city: cpacaData.ciudad || null,
          authority_department: cpacaData.departamento || null,
          ...
          auto_admisorio_date: null,
          filing_date: cpacaData.fecha_radicacion || null,
          last_action_date: null,
          last_action_description: null,
