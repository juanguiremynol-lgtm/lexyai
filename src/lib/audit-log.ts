...
export type AuditAction =
  ...
  | "PLATFORM_SUBSCRIPTION_UNSUSPENDED"
  | "PLATFORM_ORG_IMPERSONATION_STARTED"
  | "PLATFORM_ORG_IMPERSONATION_ENDED"
  | "PLATFORM_VOUCHER_CREATED"
  | "PLATFORM_VOUCHER_REVOKED"
  | "PLATFORM_VOUCHER_REDEEMED"
  | "PLATFORM_TIER_CHANGED"
  | "PLATFORM_LIMIT_OVERRIDE_SET"
  // Import Actions
  | "IMPORT_STARTED"
  | "IMPORT_COMPLETED"
  | "IMPORT_FAILED"
