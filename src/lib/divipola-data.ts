// DIVIPOLA Data - Colombian Geographic Codes (DANE)
// Source: DANE Geoportal - Listados_DIVIPOLA.xlsx
...
export const DIVIPOLA: Record<string, Departamento> = {
  "05": {
    nombre: "ANTIOQUIA",
    municipios: [
      { codigo: "05001", nombre: "MEDELLÍN", tipo: "CM" },
  ...
  "08": {
    nombre: "ATLÁNTICO",
    municipios: [
      { codigo: "08001", nombre: "BARRANQUILLA", tipo: "CM" },
  ...
  "11": {
    nombre: "BOGOTÁ, D.C.",
    municipios: [
      { codigo: "11001", nombre: "BOGOTÁ, D.C.", tipo: "CM" },
    ]
  },
  "13": {
    nombre: "BOLÍVAR",
    municipios: [
      { codigo: "13001", nombre: "CARTAGENA DE INDIAS", tipo: "CM" },
  ...
  "15": {
    nombre: "BOYACÁ",
    municipios: [
      { codigo: "15001", nombre: "TUNJA", tipo: "CM" },
  ...
  "17": {
    nombre: "CALDAS",
    municipios: [
      { codigo: "17001", nombre: "MANIZALES", tipo: "CM" },
  ...
  "18": {
    nombre: "CAQUETÁ",
    municipios: [
      { codigo: "18001", nombre: "FLORENCIA", tipo: "CM" },
  ...
  "19": {
    nombre: "CAUCA",
    municipios: [
      { codigo: "19001", nombre: "POPAYÁN", tipo: "CM" },
  ...
  "20": {
    nombre: "CESAR",
    municipios: [
      { codigo: "20001", nombre: "VALLEDUPAR", tipo: "CM" },
  ...
  "23": {
    nombre: "CÓRDOBA",
    municipios: [
      { codigo: "23001", nombre: "MONTERÍA", tipo: "CM" },
  ...
  "27": {
    nombre: "CHOCÓ",
    municipios: [
      { codigo: "27001", nombre: "QUIBDÓ", tipo: "CM" },
  ...
  "41": {
    nombre: "HUILA",
    municipios: [
      { codigo: "41001", nombre: "NEIVA", tipo: "CM" },
  ...
  "44": {
    nombre: "LA GUAJIRA",
    municipios: [
      { codigo: "44001", nombre: "RIOHACHA", tipo: "CM" },
  ...
  "47": {
    nombre: "MAGDALENA",
    municipios: [
      { codigo: "47001", nombre: "SANTA MARTA", tipo: "CM" },
  ...
  "50": {
    nombre: "META",
    municipios: [
      { codigo: "50001", nombre: "VILLAVICENCIO", tipo: "CM" },
  ...
  "52": {
    nombre: "NARIÑO",
    municipios: [
      { codigo: "52001", nombre: "PASTO", tipo: "CM" },
  ...
  "54": {
    ...
    municipios: [
      { codigo: "54001", nombre: "SAN JOSÉ DE CÚCUTA", tipo: "CM" },
  ...
  "63": {
    nombre: "QUINDÍO",
    municipios: [
      { codigo: "63001", nombre: "ARMENIA", tipo: "CM" },
  ...
  "66": {
    nombre: "RISARALDA",
    municipios: [
      { codigo: "66001", nombre: "PEREIRA", tipo: "CM" },
  ...
  "68": {
    nombre: "SANTANDER",
    municipios: [
      { codigo: "68001", nombre: "BUCARAMANGA", tipo: "CM" },
  ...
  "70": {
    nombre: "SUCRE",
    municipios: [
      { codigo: "70001", nombre: "SINCELEJO", tipo: "CM" },
      ...
      { codigo: "70823", nombre: "TOLUVIEJO" },
    ]
  },
  "73": {
    nombre: "TOLIMA",
    municipios: [
      { codigo: "73001", nombre: "IBAGUÉ", tipo: "CM" },
  ...
  "76": {
    ...
    municipios: [
      { codigo: "76001", nombre: "CALI", tipo: "CM" },
  ...
  "81": {
    nombre: "ARAUCA",
    municipios: [
      { codigo: "81001", nombre: "ARAUCA", tipo: "CM" },
  ...
  "85": {
    nombre: "CASANARE",
    municipios: [
      { codigo: "85001", nombre: "YOPAL", tipo: "CM" },
  ...
  "86": {
    nombre: "PUTUMAYO",
    municipios: [
      { codigo: "86001", nombre: "MOCOA", tipo: "CM" },
  ...
  "91": {
    nombre: "AMAZONAS",
    municipios: [
      { codigo: "91001", nombre: "LETICIA", tipo: "CM" },
      { codigo: "91263", nombre: "EL ENCANTO", tipo: "ANM" },
      { codigo: "91405", nombre: "LA CHORRERA", tipo: "ANM" },
      { codigo: "91407", nombre: "LA PEDRERA", tipo: "ANM" },
      { codigo: "91430", nombre: "LA VICTORIA", tipo: "ANM" },
      { codigo: "91460", nombre: "MIRITÍ - PARANÁ", tipo: "ANM" },
      { codigo: "91530", nombre: "PUERTO ALEGRÍA", tipo: "ANM" },
      { codigo: "91536", nombre: "PUERTO ARICA", tipo: "ANM" },
      { codigo: "91540", nombre: "PUERTO NARIÑO" },
      { codigo: "91669", nombre: "PUERTO SANTANDER", tipo: "ANM" },
      { codigo: "91798", nombre: "TARAPACÁ", tipo: "ANM" },
    ]
  },
  "94": {
    nombre: "GUAINÍA",
    municipios: [
      { codigo: "94001", nombre: "INÍRIDA", tipo: "CM" },
      { codigo: "94343", nombre: "BARRANCOMINAS" },
      { codigo: "94663", nombre: "MAPIRIPANA", tipo: "ANM" },
      { codigo: "94883", nombre: "SAN FELIPE", tipo: "ANM" },
      { codigo: "94884", nombre: "PUERTO COLOMBIA", tipo: "ANM" },
      { codigo: "94885", nombre: "LA GUADALUPE", tipo: "ANM" },
      { codigo: "94886", nombre: "CACAHUAL", tipo: "ANM" },
      { codigo: "94887", nombre: "PANA PANA", tipo: "ANM" },
      { codigo: "94888", nombre: "MORICHAL", tipo: "ANM" },
    ]
  },
  "95": {
    nombre: "GUAVIARE",
    municipios: [
      { codigo: "95001", nombre: "SAN JOSÉ DEL GUAVIARE", tipo: "CM" },
  ...
  "97": {
    nombre: "VAUPÉS",
    municipios: [
      { codigo: "97001", nombre: "MITÚ", tipo: "CM" },
      { codigo: "97161", nombre: "CARURÚ" },
      { codigo: "97511", nombre: "PACOA", tipo: "ANM" },
      { codigo: "97666", nombre: "TARAIRA" },
      { codigo: "97777", nombre: "PAPUNAHUA", tipo: "ANM" },
      { codigo: "97889", nombre: "YAVARATÉ", tipo: "ANM" },
    ]
  },
  "99": {
    nombre: "VICHADA",
    municipios: [
      { codigo: "99001", nombre: "PUERTO CARREÑO", tipo: "CM" },
...
// Corporation/Juzgado options
export const CORP_OPTIONS = [
  { code: "00", label: "00 — Corte Suprema" },
  { code: "01", label: "01 — Consejo de Estado" },
  { code: "05", label: "05 — Consejo Superior de la Judicatura" },
  { code: "10", label: "10 — Sala Disciplinaria" },
  { code: "11", label: "11 — Tribunal Superior" },
  { code: "12", label: "12 — Tribunal Administrativo" },
  { code: "31", label: "31 — Juzgado de Circuito" },
  { code: "40", label: "40 — Juzgado Municipal" },
  { code: "41", label: "41 — Juzgado Promiscuo Municipal" },
  { code: "42", label: "42 — Juzgado Municipal de Pequeñas Causas" },
  { code: "__custom__", label: "(Personalizado)" },
];

// Specialty options
export const SPEC_OPTIONS = [
  { code: "01", label: "01 — Civil" },
  { code: "02", label: "02 — Penal" },
  { code: "03", label: "03 — Laboral" },
  { code: "04", label: "04 — Familia" },
  { code: "05", label: "05 — Menores" },
  { code: "89", label: "89 — Promiscuo / Mixto" },
  { code: "99", label: "99 — Administrativo" },
  { code: "__custom__", label: "(Personalizado)" },
];

// Utility functions
export function formatRadicado(digits: string): string {
...
export function normalizeCode(str: string, len: number): string {
  const d = onlyDigits(str);
  return padLeft(d, len).slice(-len);
}
